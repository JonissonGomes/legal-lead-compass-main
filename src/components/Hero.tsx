          ...
          <div className="animate-fade-up">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8">
              <Button 
                ...
                onClick={() => window.open('https://wa.me/5581985058518?text=Olá,%20quero%20uma%20consulta%20gratuita%20sobre%20direitos%20jurídicos', '_blank')}
              >
...
const WhatsAppButton = () => {
  ...
  return (
    <a
      href="https://wa.me/5581985058518?text=Olá,%20quero%20uma%20consulta%20gratuita%20sobre%20direitos%20jurídicos"
      target="_blank"
